...
Route::prefix('medical')->group(function () {
    ...
    Route::get('register', "Medical\MedicalController@register")->name('register.medical');
    ...
    Route::post('/new/register/', "medical\MedicalController@store_register")->name('medical.register');
});
