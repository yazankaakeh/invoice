                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content modal-content-demo">
                                <div class="modal-header">
                                    <h6 class="modal-title">حذف بيانات  الطفل من العائلة</h6><button aria-label="Close" class="close" data-dismiss="modal"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                ...
                                <div class="form-group">{{-- it must be select options  --}}
                                    <p class="exampleInputEmail">الهوية الشخصية من اي ولاية</p>
