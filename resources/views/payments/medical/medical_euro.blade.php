...
<div class="breadcrumb-header justify-content-between">
     <div class="my-auto">
    <div class="d-flex">
<h4 class="my-auto mb-0 content-title"> قسم الطبي </h4><span class="mt-1 mb-0 mr-2 text-muted tx-13">/ قسم مدفوعات الطبي باليورو </span>
</div>
</div>
                            ...
                            <div class="card mg-b-20">
                                ...
                                <div class="card-body">
                                    <div class="main-content-label mg-b-5">
                                        قائمة  مدفوعات الطبي باليورو  .
                                    </div>
                                    <p class="mg-b-20">معلومات  مدفوعات الطبي باليورو.</p>
                                                ...
                                                <tr>
                                                    ...
                                                    @can(' تعديل دفعة باليورو الطبي ')
                                                            <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                                ...
                                                                data-medical_value_euro="{{$x->medical_value_euro}}" data-medical_value_euro="{{$x->medical_value_euro }}"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ Route('euro.update.medical') }}" method="post" autocomplete="off">
                                        {{ method_field('patch') }}
                                        {{ csrf_field() }}
                                        <div class="modal-body">
                                        ...
                                        <input class="form-control" name="medical_value_euro" id="medical_value_euro" type="text" >
                                        <input class="form-control" name="medical_value_euro1" id="medical_value_euro" type="hidden" >
                                        </div>
                    ...
                    <div class="modal" id="modaldemo9">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content modal-content-demo">
                                ...
                                <form action="{{ Route('euro.destroy.medical') }}" method="post">
                                    {{ method_field('delete') }}
                                    {{ csrf_field() }}
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="modal-body">
                                        <label for="recipient-name" class="col-form-label">المبلغ بالدولار</label>
                                        <input class="form-control" name="medical_value_euro" id="medical_value_euro" type="text" readonly>
                                        </div>
