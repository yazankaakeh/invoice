                                                ...
                                                <tr>
                                                    ...
                                                    @can(' تعديل دفعة بالتركي الطلاب ')
                                                            ...
                                                            <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                                ...
                                                                data-number_bim_student="{{$x->number_bim_student }}" data-student_value_bim_student="{{$x->student_value_bim_student}}"
                                                                data-student_value_euro="{{$x->student_value_euro }}" data-student_value="{{$x->student_value}}"
                                                                 data-note="{{$x->Note }}"
                                                                data-toggle="modal"
                                                    ...
                                                    @can(' حذف دفعة بالتركي الطلاب ')
                                                            <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                                                data-id="{{ $x->id }}"  data-student_value="{{$x->value }}"
                                                                data-number_bim_student="{{$x->number_bim_student }}"data-student_value_bim_student="{{$x->student_value_bim_student}}"
                                                                 data-note="{{$x->Note }}"
                            ...
                            <div class="modal-content modal-content-demo">
                                ...
                                <form action="{{ Route('tr.destroy.student') }}" method="post">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <input type="hidden" name="student_id" id="student_id" student_value="" readonly>
                                        <input type="hidden" name="id" id="id" student_value="">
                    ...
                    <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ Route('tr.update.student') }}" method="post" autocomplete="off">
                                        {{ method_field('patch') }}
                                        {{ csrf_field() }}
                                        <div class="modal-body">
                                            <input type="hidden" name="id" id="id" student_value="" readonly>
                                            <input type="hidden" name="student_id" id="student_id" student_value="" readonly>
                                            <label for="recipient-name" class="col-form-label">اسم الطالب:</label>
                                            <input class="form-control" name="student_name" id="student_name" type="text" readonly>
                                        </div>
...
<script>
    $('#exampleModal2').on('show.bs.modal', function(event) {
        ...
        var student_value = button.data('student_value')
        var note = button.data('note')
        var student_value = button.data('student_value')
        var student_name = button.data('student_name')
        var student_value_euro = button.data('student_value_euro')
        var number_bim_student = button.data('number_bim_student')
        var student_value_bim_student = button.data('student_value_bim_student')
        var modal = $(this)
        ...
        modal.find('.modal-body #student_value_bim_student').val(student_value_bim_student);
    })
</script>
