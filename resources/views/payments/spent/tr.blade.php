				...
				<div class="row">
                                        ...
                                        <table id="example" class="table key-buttons text-md-nowrap">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$x->updated_at}}</td>
                                                    <td>
                                                    @can(' تعديل مدفوعات بالتركي ')
                                                            <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                                data-id="{{$x->id}}"
                                                                data-user_name="{{$x->user_name}}" data-note="{{$x->Note }}"
                                                                data-spent_value="{{$x->spent_value}}" data-desc="{{$x->desc}}"
                                                                data-toggle="modal"
                                                    ...
                                                    @can(' حذف مدفوعات بالتركي ')
                                                            <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                                                data-desc="{{$x->desc}}" data-id="{{ $x->id }}" data-note="{{$x->Note }}"
                                                                data-spent_value="{{$x->spent_value}}" data-user_name="{{$x->user_name}}"
                    ...
                    <div class="modal" id="modaldemo9">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content modal-content-demo">
                                <div class="modal-header">
                                    <h6 class="modal-title">حذف الدفعة</h6><button aria-label="Close" class="close" data-dismiss="modal"
                                        type="button"><span aria-hidden="true">&times;</span></button>
                                </div>
                                <form action="{{Route('tr.destroy')}}" method="post">
                                    {{ method_field('delete') }}
                                    {{ csrf_field() }}
                                    <div class="modal-body">
                                        ...
                                        <div class="modal-body">
                                            <label for="recipient-name" class="col-form-label">المبلغ المحذوف بالتركي</label>
                                            <input class="form-control" name="spent_value" id="spent_value" type="text" readonly>
                                        </div>
                    ...
                    <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">تعديل الدفعة بالتركي</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <form action="{{ Route('tr.update') }}" method="post" autocomplete="off">
                                        {{ method_field('patch') }}
                                        {{ csrf_field() }}
                                        <div class="modal-body">
                                        <input type="hidden" name="id" id="id" value="">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <input class="form-control" name="spent_value1" id="spent_value" type="hidden" >
                                        </div>
...
<script>
    $('#exampleModal2').on('show.bs.modal', function(event) {
        ...
        var spent_value = button.data('spent_value')
        var modal = $(this)
        modal.find('.modal-body #id').val(id);
        modal.find('.modal-body #user_name').val(user_name);
        modal.find('.modal-body #note').val(note);
        modal.find('.modal-body #spent_value').val(spent_value);
