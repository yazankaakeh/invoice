...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="my-auto mb-0 content-title"> الأقسام</h4><span class="mt-1 mb-0 mr-2 text-muted tx-13">الطلاب المؤجلين/قسم الطلاب</span>
						</div>
					</div>
                            ...
                            <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="example" class="table key-buttons ">
                                            ...
                                            <tbody>
                                                @foreach($univ as $x)
                                                @if($x->student_id != null && $x->student->new_statu == 4)
