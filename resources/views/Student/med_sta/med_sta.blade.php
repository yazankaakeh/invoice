                        ...
                        <div class="col-xl-12">
                            <div class="card mg-b-20">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="mg-b-20">معلومات الحالة الصحية للطلاب .</p>
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content modal-content-demo">
                                <div class="modal-header">
                                    <h6 class="modal-title">حذف بيانات الحالة الصحية</h6><button aria-label="Close" class="close" data-dismiss="modal"
                    ...
                    <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">تعديل بيانات الحالة الصحية</h5>
