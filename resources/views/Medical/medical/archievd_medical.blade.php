...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="my-auto mb-0 content-title">الأقسام </h4><span class="mt-1 mb-0 mr-2 text-muted tx-13">/قسم المرضى المؤرشفين </span>
						</div>
					</div>
                                    ...
                                    <div class="table-responsive">
                                        <table id="example" class="table key-buttons ">
                                            ...
                                            <tbody>
                                                ...
                                                @if ($x->medical_id != null && $x->medical->new_statu == 3 )
                                                <tr>
                                                    <td>{{$x->medical->id}}</td>
                                                    <td>{{$x->medical->medical_name}}</td>
                                                    <td>
                                                        <span class="label text-warning d-flex">
                                                        <div  class="dot-label bg-warning ml-1"></div>أرشيف
                                                        </span>
                                                    </td>
