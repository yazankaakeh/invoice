...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="my-auto mb-0 content-title">اقسام عامة</h4><span class="mt-1 mb-0 mr-2 text-muted tx-13">/ قسم العمل للطبي</span>
						</div>
					</div>
                        ...
                        <div class="col-xl-12">
                            <div class="card mg-b-20">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="mg-b-20">معلومات  العمل للطبي .</p>
                    ...
                    <div class="modal" id="modaldemo9">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content modal-content-demo">
                                ...
                                <form action="{{ Route('job.destroy.medical') }}" method="post">
                                    {{ method_field('delete') }}
                                    {{ csrf_field() }}
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                 ...
                                 <form action="{{ route('job.update.medical') }}" method="post">
                                {{ method_field('patch') }}
                                {{ csrf_field() }}
                               <div class="modal-body">
                                <input type="hidden" name="id" id="id" readonly>
